...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/crimson-field-ea72#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/crimson-field-ea72
```

A live public deployment of this template is available at [https://crimson-field-ea72.templates.workers.dev](https://crimson-field-ea72.templates.workers.dev)
